...
def build_vectorstore(splits, embed_model_name: str):
    emb = GoogleGenerativeAIEmbeddings(model=embed_model_name, google_api_key=os.getenv("GOOGLE_API_KEY"))
...
def setup_pipeline(pdf_path: str, chunk_size=1000, chunk_overlap=150, embed_model_name="models/text-embedding-004", force_rebuild=False):
